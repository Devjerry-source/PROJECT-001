...
df_std = pd.read_csv('/storage/emulated/0/Jeremiah.py/newWizzy.csv')
...
def creating_report(student_num):
    ...
    pdf.image(f'/storage/emulated/0/Jeremiah.py/{student_num}.jpg', x = 9.0, y = 1)
    pdf.ln(0.20)
    pdf.cell(6, 0.0, name)
    ...
    pdf.image('/storage/emulated/0/Jeremiah.py/time_sec.png', x= 1, w = 2 )
    pdf.image('/storage/emulated/0/Jeremiah.py/time_hrs.png', x = 3, y = 5, w = 2)
    pdf.image('/storage/emulated/0/Jeremiah.py/performance.png', x = 5, y = 5, w = 2 )
    pdf.image('/storage/emulated/0/Jeremiah.py/Attempts.png', x = 7, y = 5, w = 2 )
    pdf.image('/storage/emulated/0/Jeremiah.py/Accuracy.png', x = 9, y = 5, w = 2 )
