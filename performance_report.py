...
df_std = pd.read_csv(r'C:/Users/hp 6730/.spyder-py3/wizzy.csv')
...
def creating_report(student_num):
    ...
    pdf.image(f'C:/Users/hp 6730/.spyder-py3/{student_num}.jpg', x = 9.0, y = 1)
    pdf.ln(0.20)
    pdf.cell(6, 0.0, name)
    ...
    pdf.image('C:/Users/hp 6730/.spyder-py3/time_sec.png', x= 1, w = 2 )
    pdf.image('C:/Users/hp 6730/.spyder-py3/time_hrs.png', x = 3, y = 5, w = 2)
    pdf.image('C:/Users/hp 6730/.spyder-py3/performance.png', x = 5, y = 5, w = 2 )
    pdf.image('C:/Users/hp 6730/.spyder-py3/Attempts.png', x = 7, y = 5, w = 2 )
    pdf.image('C:/Users/hp 6730/.spyder-py3/Accuracy.png', x = 9, y = 5, w = 2 )
